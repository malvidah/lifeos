    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div>
        ...
        <div style={BODY_TEXT}>
          ...
          <p style={{ margin: '0 0 14px' }}>
            Log meals with a tap, track habits with a check, journal your thoughts, and let AI connect the dots. Your health data flows in from Oura and Apple Health. Your calendar syncs from Google. Voice commands let you add anything hands-free.
          </p>
          <p style={{ margin: 0 }}>
            Every day, Day Lab builds a picture of how you&rsquo;re doing &mdash; not just what you ate or how you slept, but how it all fits together. The 3D mountain map shows your projects growing over time. The AI spots patterns you&rsquo;d miss. And everything lives in one beautiful, private dashboard that&rsquo;s actually yours.
          </p>
        </div>
      </div>
