    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          html[data-theme="light"], html[data-theme="light"] body { background: #E6DFD4 !important; }
          html[data-theme="dark"], html[data-theme="dark"] body { background: #222220 !important; }
          html:not([data-theme]) body { background: #222220 !important; }
        `}} />
