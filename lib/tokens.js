...
// Single source of truth for all visual constants across Dashboard + Editor.
// projectColor and CHIP_TOKENS are canonical in Editor.jsx — re-exported here
...
// Re-export from Editor (canonical source for project visual identity)
export { projectColor, CHIP_TOKENS } from '@/components/Editor.jsx';
