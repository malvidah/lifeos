...
export function getRecurrenceSuggestions(query) {
  ...
  const options = [
    ...
    { label: '1/week',    key: '1pw',      search: '1x/week 1x per week once weekly 1 per week 1pw' },
    { label: '2/week',    key: '2pw',      search: '2x/week 2x per week twice weekly 2 per week 2pw' },
    { label: '3/week',    key: '3pw',      search: '3x/week 3x per week three times weekly 3 per week 3pw' },
    { label: '4/week',    key: '4pw',      search: '4x/week 4x per week four times weekly 4 per week 4pw' },
    { label: '5/week',    key: '5pw',      search: '5x/week 5x per week five times weekly 5 per week 5pw' },
    { label: '6/week',    key: '6pw',      search: '6x/week 6x per week six times weekly 6 per week 6pw' },
