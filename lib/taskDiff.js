...
export async function applyDiff(date, diff, token) {
  ...
  // Note: recurring/habit checkbox toggles are intercepted at the DOM level
  // (Editor.jsx handleDOMEvents.mousedown) and never reach here.
  // The PATCH guard on the server also rejects done=true on templates as a safety net.
