...
export function SearchResults({ results, loading, query, onSelectDate }) {
  ...
  if (loading && !results) return (
    <div style={{ display: 'flex', justifyContent: 'center', paddingTop: 40 }}>
      <span style={{ fontFamily: mono, fontSize: 9, color: "var(--dl-highlight)", letterSpacing: '0.15em', textTransform: 'uppercase' }}>searching…</span>
    </div>
  );
  ...
  if (results.length === 0) return (
    <div style={{ display: 'flex', justifyContent: 'center', paddingTop: 60 }}>
      <span style={{ fontFamily: mono, fontSize: 10, color: "var(--dl-middle)", letterSpacing: '0.06em' }}>No results match your search</span>
    </div>
  );
          ...
          <div key={date} style={{ marginBottom: 20 }}>
            ...
            <div
              ...
              style={{ fontFamily: mono, fontSize: 10, letterSpacing: '0.06em', textTransform: 'uppercase',
                color: "var(--dl-highlight)", padding: '10px 2px 8px', cursor: 'pointer', display: 'inline-block',
