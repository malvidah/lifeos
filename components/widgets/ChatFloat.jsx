...
export function InsightsCard({date, token, userId, healthKey, collapsed, onToggle}) {
  ...
  return (
    <Card label="Insights" color={"var(--dl-muted)"} slim collapsed={collapsed} onToggle={onToggle}>
      ...
      {expanded && (
        <div style={{
          ...
          <div style={{
            ...
            onMouseEnter={e => { e.currentTarget.style.color = "var(--dl-text)"; e.currentTarget.style.background = "var(--dl-text)0e"; }}
                ...
                <Fragment key={i}>
                  <div style={{
                    ...
                    <div style={{
                      ...
                      background: msg.role === "user" ? "var(--dl-accent)" : "var(--dl-text)0e",
