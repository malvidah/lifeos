...
const SCHEDULE_OPTIONS = [
  ...
  { key: 'weekends', label: 'Weekends (S·U)', chip: 'S·U', search: 'weekends weekend saturday sunday saturdays sundays' },
  { key: 'mon', label: 'Monday', chip: 'M', search: 'monday mon mondays m' },
  { key: 'tue', label: 'Tuesday', chip: 'T', search: 'tuesday tue tuesdays t' },
  { key: 'wed', label: 'Wednesday', chip: 'W', search: 'wednesday wed wednesdays w' },
  { key: 'thu', label: 'Thursday', chip: 'R', search: 'thursday thu thursdays thurs r' },
  { key: 'fri', label: 'Friday', chip: 'F', search: 'friday fri fridays f' },
  { key: 'sat', label: 'Saturday', chip: 'S', search: 'saturday sat saturdays s' },
  { key: 'sun', label: 'Sunday', chip: 'U', search: 'sunday sun sundays u' },
];
                ...
                return (
                  <React.Fragment key={d}>
                    ...
                    <div
                      ...
                      style={{ width: colW, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', cursor: 'pointer' }}>
                      {perfect && <span style={{ fontSize: 11, lineHeight: 1, marginBottom: 4 }}>🎉</span>}
                      <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingBottom: 2, borderRadius: '6px 6px 0 0', background: d === date ? 'var(--dl-accent-10, rgba(208,136,40,0.1))' : 'transparent' }}>
